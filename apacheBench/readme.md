...
#### Команда
```shell
ab -n 500 -c 50 -g out.data http://localhost:8081/api/v1/auth/sign-up
```
...
Document Path:          /api/v1/auth/sign-up
...
#### Команда
```shell
ab -n 1000 -c 100 -g out.data http://localhost:8081/api/v1/auth/sign-up
```
...
#### Команда
```shell
ab -n 2500 -c 250 -g out.data http://localhost:8081/api/v1/auth/sign-up
```
